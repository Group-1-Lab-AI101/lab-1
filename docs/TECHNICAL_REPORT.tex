...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{P{4.2cm} Y P{2cm}}
        ...
        Graph, dataset, and cost & 1,662 nodes, 3,649 directed edges, weighted traffic cost & Complete \\
        ...
        Verification & 72 tests, all-pair audit, and frontend production build & Complete \\
        \bottomrule
    \end{tabularx}
\end{table}
...
records, and approximately 331.591 km of directed road geometry. The loader
normalizes duplicate endpoint pairs and retains the largest strongly connected
graph.
...
\begin{itemize}
    ...
    \item Curated access points should be periodically reviewed against OSM changes.
    \item Pedestrian-only paths require a separate walking graph.
...
mode, support turn restrictions, and evaluate a larger reproducible scenario
suite.
